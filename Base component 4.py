# this version is base on the feedback I received from tester
# possible inprovements
# 1. the number of snacks - in the program there's must have a instruction
#about how many snack the user can buy (done)
# 2. When enter the names, the name must not be the same (done)
# 3. Show the charges for different payment methods (done)
# for me
# 4. No snack export file printed if the snack asking question received a 'no' (done)
